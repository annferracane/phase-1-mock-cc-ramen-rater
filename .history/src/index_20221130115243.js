...
function buildNewMenuItem(formInput) {
    let newMenuItem;
    newMenuItem[formInput.name] = formInput.textContent;
    return newMenuItem;
}
...
function addNewRamenHandler(event) {
    ...
    const newMenuItem = {};
    formInputs.forEach(formInewMenuItem[formInput.name] = formInput.textContent);
}
